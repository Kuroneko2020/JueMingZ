        ...
        private struct RuntimeSettingsSignature : IEquatable<RuntimeSettingsSignature>
        {
                ...
                bool legacyMiscUiNeedsInventorySnapshot)
            {
                ...
                return new RuntimeSettingsSignature
                {
                    ...
                    _inventoryAutoSellItemIdsHash = HashInts(settings.InventoryAutoSellItemIds),
                    _inventoryAutoDiscardEnabled = settings.InventoryAutoDiscardEnabled,
                    _inventoryAutoDiscardItemIdsHash = HashInts(settings.InventoryAutoDiscardItemIds),
                    ...
                    _npcAutoReforgePrefixesHash = HashStrings(settings.NpcAutoReforgePrefixes),

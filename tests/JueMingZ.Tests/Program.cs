...
namespace JueMingZ.Tests
{
    internal static partial class Program
    {
        ...
        private static int Main()
        {
            ...
            Run("blueprint entry hotkey blocks text input and debounces", ref failed, BlueprintEntryHotkeyBlocksTextInputAndDebounces);
            Run("blueprint entry hotkey conflict registry reports entry owner", ref failed, BlueprintEntryHotkeyConflictRegistryReportsEntryOwner);
            ...
            Run("blueprint handheld action bar commands stay UI-only", ref failed, BlueprintHandheldActionBarCommandsStayUiOnly);
